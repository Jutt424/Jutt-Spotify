...
async function getSongs(folder) {
    try {
        currFolder = folder;
        let response = await fetch(`http://192.168.0.108:3000//${folder}/`);
    ...
    try {
        ...
        play.addEventListener("click", () => {
            if (currentSong.paused) {
                currentSong.play();
                play.src = "img/pause.svg"; // Update the path accordingly
            } else {
                currentSong.pause();
                play.src = "img/play1.svg"; // Update the path accordingly
            }
